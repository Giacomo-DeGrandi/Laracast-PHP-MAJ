            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/about.php" class=" <?= isUrl('/about.php') ? 'bg-gray-900 text-white hover:text-white' : 'text-gray-300 hover:bg-gray-700'  ?>  rounded-md px-3 py-2 text-sm font-medium">About</a>
                        <a href="/contact.php" class="<?= isUrl('/contact.php') ? 'bg-gray-900 text-white  hover:text-white' : 'text-gray-300 hover:bg-gray-700'  ?> rounded-md px-3 py-2 text-sm font-medium">Contact</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
