...
<main>
    ...
    <form method="POST" class="px-6" action="/note">
            ...
            <div class="border-b border-gray-900/10 pb-12">
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <textarea id="body" name="body" rows="7" class="block w-3/4 rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-100 focus:ring-2  focus:ring-indigo-200 sm:text-sm">
                                <?= $note['body'] ?? "" ?>
                            </textarea>
                        </div>
